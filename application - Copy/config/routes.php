...
//upload
$route['(\w{2})?/?checkout/successcashup'] = 'uploadp/successPaymentCashOnD';
...
$route['product_grid_get'] = "Product/getProductGrid";



$route['auto_fill_search'] = 'home/getauto_fill_search';
$route['product_categories'] = 'home/getCategories';
$route['product_categories_pagination'] = 'home/getpagination';

// Product page 
//$route['product_grid'] = 'Product/getpagination';
//$route['product_list'] = 'home/getpagination';

$route['product_grid'] = "Product";
$route['product_title_list'] = "Product/getauto_fill_search";
$route['product_grid_P/(:num)'] = "Product/index/$1";
$route['home/product_list/(:num)'] = "Product/index/$1";
$route['home/product_category'] = "Product/searchcategory";
...
$route['admin/productStatusChange1'] = "admin/ecommerce/products/productStatusChange1";
...
$route['admin/orders_p'] = "admin/ecommerce/orders_p";
$route['admin/orders_p/(:num)'] = "admin/ecommerce/orders_p/index/$1";


$route['admin/changeOrdersOrderStatus'] = "admin/ecommerce/orders/changeOrdersOrderStatus";
$route['admin/changeOrdersOrderStatus2'] = "admin/ecommerce/orders/changeOrdersOrderStatus2";
