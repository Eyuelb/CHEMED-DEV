...
<link href="<?= base_url('assets/admin/css-gradient-generator/src/css-gradient-generator.css') ?>" rel="stylesheet" type="text/css" media="all">
<link href="<?= base_url('assets/admin/css-gradient-generator/resources/icomoon/sprites.css') ?>" rel="stylesheet" type="text/css">
<link href="<?= base_url('assets/admin/css-gradient-generator/resources/bootstrap-colorpickersliders/bootstrap.colorpickersliders.css') ?>" rel="stylesheet" type="text/css" media="all">
...
<script src="<?= base_url('assets/admin/css-gradient-generator/resources/bootstrap-touchspin/bootstrap.touchspin.js') ?>"></script>
<script src="<?= base_url('assets/admin/css-gradient-generator/resources/tinycolor/tinycolor.js') ?>"></script>
<script src="<?= base_url('assets/admin/css-gradient-generator/resources/bootstrap-colorpickersliders/bootstrap.colorpickersliders.js') ?>"></script>
<script src="<?= base_url('assets/admin/css-gradient-generator/src/css-gradient-generator.js') ?>"></script>
<script src="<?= base_url('assets/admin/css-gradient-generator/resources/jquery.base64/jquery.base64.min.js') ?>"></script>
<script src="<?= base_url('assets/admin/css-gradient-generator/resources/qrcode/qrcode.min.js') ?>"></script>
<script>
