<h1><img src="<?= base_url('assets/admin/imgs/template-admin-logo.png') ?>" class="header-img" style="margin-top:-2px;"> Templates</h1>
<hr>
        ...
        <div class="col-sm-4" style="margin-bottom: 10px;">
            <a href="javascript:void(0);" data-form-id="saveTemplate" data-template-name="<?= $template ?>" class="confirm-save choose-template">
                ...
                <?php if ($seleced_template == $template) { ?>
                    <img class="selected-template" alt="CHOOSED" src="<?= base_url('assets/admin/imgs/ok-themes.png') ?>">
                <?php } ?>
            </a>
        </div>
    <?php } ?>
