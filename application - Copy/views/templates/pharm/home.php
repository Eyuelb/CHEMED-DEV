							...
							<div class="row">
								<div class="col-lg-7 col-12">
									<div class="hero-text">
										...
										<div class="button">
											<a class="btn" href=" <?= LANG_URL. '/product_grid' ?>">Shop Now!</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-4 col-12">
					<div class="single-banner tab-height">
						...
						<div class="content">
							...
							<a href="<?= LANG_URL . '/product_grid' ?>">Discover Now</a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
                                    ...
                                    <img class="hover-img" src="<?= base_url('/attachments/shop_images/' . $article['image']) ?>" alt="<?= str_replace('"', "'", $article['title']) ?>" onerror="this.onerror=null; this.src= '<?= base_url('attachments/shop_images/no_image8.jpg') ?>' ">
										...
										<div class="button-head">
											<div class="product-action">
												<a title="Quick View" href="<?= $article['vendor_url'] == null ? LANG_URL . '/' . $article['url'] : LANG_URL . '/' . $article['vendor_url'] . '/' . $article['url'] ?>"><i class=" ti-eye" ></i><span>Quick Shop</span></a>
					...
					<div class="col-12">
						<div class="product-info">
							<div class="nav-main">
								<!-- Tab Nav -->
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#man" role="tab">New arrivals</a></li>
								</ul>
								<!--/ End Tab Nav -->
							</div>
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
										<div class="row" id="product_list">
										<?php foreach($newProducts as $article){ ?>
                            <div class="col-xl-3 col-lg-4 col-md-4 col-12">
								<div class="single-product">
								<div class="product-img">
									<a href="<?= $article['vendor_url'] == null ? LANG_URL . '/' . $article['url'] : LANG_URL . '/' . $article['vendor_url'] . '/' . $article['url'] ?>">
