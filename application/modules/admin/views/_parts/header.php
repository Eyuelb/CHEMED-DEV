...
<html lang="en">
    <head>
        ...
        <title><?= $title ?></title>
        <link href="<?= base_url('assets/admin/css/bootstrap.min.css').'?'.date('l jS \of F Y h:i:s A') ?>" rel="stylesheet">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="<?= base_url('assets/admin/bootstrap-select-1.12.1/bootstrap-select.min.css').'?'.date('l jS \of F Y h:i:s A') ?>">
        <link href="<?= base_url('assets/admin/css/custom-admin.css').'?'.date('l jS \of F Y h:i:s A') ?>" rel="stylesheet">
        <link href='https://fonts.googleapis.com/css?family=Inconsolata' rel='stylesheet' type='text/css'>
        <script src="<?= base_url('assets/admin/js/jquery.min.js').'?'.date('l jS \of F Y h:i:s A') ?>"></script>
        <!--[if lt IE 9]>
                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li>
                                        <a href="<?= base_url('admin/orders_p') ?>" <?= urldecode(uri_string()) == 'admin/orders_p' ? 'class="active"' : '' ?>>
                                            <i class="fa fa-money" aria-hidden="true"></i> Orders Via Prescription
                                            <?php if ($numNotPreviewOrders > 0) { ?>
                                                <img src="<?= base_url('assets/imgs/exlamation-hi.png') ?>" style="position: absolute; right:10px; top:7px;" alt="">
                                            <?php } ?>
                                        </a>
