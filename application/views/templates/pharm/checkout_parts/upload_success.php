    ...
    <div class="card">
            ...
            <div class="info">
                ...
                <div class="col-7">
                        ...
                        <span id="details">Thank you for uploading your Prescription. Our Pharmacists will contact you</span>
                    </div>
                    <div class="col-5 ">
                        <span id="heading">Order No.</span><br>
                        <span id="details"><?= $_SESSION['orderId'] ?></span>
                    </div>
                    <div class="col-7">
        ...
        $m ="You Have New Order ".$_SESSION['orderId']." on ".date("Y-m-d");
