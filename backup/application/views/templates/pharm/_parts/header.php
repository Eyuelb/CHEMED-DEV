...
<head>
	...
	<!-- CHEMED StyleSheet -->
  <link rel="stylesheet" href="<?= base_url('assets/che-med-assets/css/reset.css') ?>">
  <link rel="stylesheet" href="<?= base_url('assets/che-med-assets/css/style.css') ?>">
  <link rel="stylesheet" href="<?= base_url('assets/che-med-assets/css/responsive.css') ?>">
...
<body class="js">
	...
	<header class="header shop">
		...
		{
			?>
			<ul class="<?= $is_recursion === true ? 'mega-menu' : 'main-category anyClass' ?>">
				<?php
