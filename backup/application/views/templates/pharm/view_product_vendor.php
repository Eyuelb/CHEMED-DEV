            ...
            <div class="row row-info">
                ...
                <div class="col-sm-6 manage-buttons">
                    <?php if ($product['quantity'] > 0) { ?>
                        <a href="javascript:void(0);" data-id="<?= $product['id'] ?>" data-goto="<?= LANG_URL . '/checkout' ?>" class="btn btn-primary btn-add">
                            <span class="text-to-bg"><?= lang('buy_now') ?></span>
                        </a>
                        <a href="javascript:void(0);" data-id="<?= $product['id'] ?>" data-goto="<?= LANG_URL . '/shopping-cart' ?>" class="btn btn-primary btn-add">
